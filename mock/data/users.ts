...
const DEMO_USERS: User[] = [
  {
    ...
    avatarUrl: 'https://ui-avatars.com/api/?name=Demo+Employee&size=96&background=0066FF&color=fff',
    status: 'active',
    emailVerified: true,
  ...
  },
  {
    ...
    avatarUrl: 'https://ui-avatars.com/api/?name=Demo+HR&size=96&background=7B61FF&color=fff',
    status: 'active',
    emailVerified: true,
    lastLoginAt: new Date().toISOString(),
  ...
  },
  {
    ...
    avatarUrl: 'https://ui-avatars.com/api/?name=Demo+CHRO&size=96&background=00B87C&color=fff',
    status: 'active',
    emailVerified: true,
    lastLoginAt: new Date().toISOString(),
  ...
  },
  {
    ...
    avatarUrl: 'https://ui-avatars.com/api/?name=Demo+Admin&size=96&background=FFA733&color=fff',
    status: 'active',
    emailVerified: true,
    lastLoginAt: new Date().toISOString(),
